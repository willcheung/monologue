...
export default async function WelcomePage() {
  ...
  return <>
    ...
    <main className="setup-shell">
      ...
      {cloud ? <>
        <div className="setup-step"><div className="step-number">1</div><h2>Give this prompt to your agent</h2><p>It installs Monologue and starts a private connection.</p><pre>Read and execute https://www.monologue.events/agent-setup</pre><CopySetupButton /></div>
