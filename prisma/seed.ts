...
const actions = [
  ...
  { agentName:"Muse · Cal", verb:"rescheduled", summary:"Moved the dentist appointment from Tuesday to Thursday.", category:"calendar", system:"Google Calendar", objectType:"event", objectName:"Dentist appointment", project:"Personal", externalId:"gcal-dentist-2", occurredAt:at(0,9,22) },
  ...
  { agentName:"Muse · Cal", verb:"created", summary:"Added airport pickup to the arrival-day calendar.", category:"calendar", system:"Google Calendar", objectType:"event", objectName:"Airport pickup at HND", project:"Tokyo Trip", externalId:"gcal-tokyo-pickup", occurredAt:at(1,16,5) },
  ...
  { agentName:"Muse · Cal", verb:"created", summary:"Added the final-round interview and prep buffer.", category:"calendar", system:"Google Calendar", objectType:"event", objectName:"Final interview", project:"Job Search", externalId:"gcal-interview-final", occurredAt:at(2,10,0) },
  { agentName:"Hermes · Scout", verb:"updated", summary:"Updated the project brief with the V1 product rules.", category:"file", system:"Notion", objectType:"page", objectName:"Monologue product brief", project:"Monologue", externalId:"notion-brief-9", occurredAt:at(3,19,12) },
  ...
  { agentName:"Muse · Cal", verb:"updated", summary:"Changed the weekly portfolio review to 30 minutes.", category:"calendar", system:"Google Calendar", objectType:"event", objectName:"Portfolio review", project:"AI Hedge Fund Analyst", externalId:"gcal-portfolio-review", occurredAt:at(5,12,0) },
  ...
  { agentName:"Hermes · Scout", verb:"created", summary:"Created a shared launch notes page for the project.", category:"file", system:"Notion", objectType:"page", objectName:"Launch notes", project:"Monologue", externalId:"notion-launch-notes", occurredAt:at(8,15,15) },
  ...
  { agentName:"Muse · Cal", verb:"deleted", summary:"Removed the cancelled portfolio planning session.", category:"calendar", system:"Google Calendar", objectType:"event", objectName:"Portfolio planning", project:"AI Hedge Fund Analyst", externalId:"gcal-delete-planning", occurredAt:at(11,9,5) },
