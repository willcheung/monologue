...
const actions = [
  ...
  { agentName:"OpenClaw · Penny", verb:"purchased", summary:"Purchased two black printer toner cartridges.", category:"purchase", system:"Amazon", objectType:"order", objectName:"Printer toner", value:47.18, currency:"USD", externalId:"amazon-7741", url:"https://amazon.com/orders/7741", metadata:{ orderNumber:"113-4820917-7741", quantity:2, deliveryDate:"September 22", receiptUrl:"https://amazon.com/orders/7741/invoice" }, occurredAt:at(0,11,4) },
  { agentName:"Claude · Cal", verb:"rescheduled", summary:"Rescheduled the dentist appointment.", category:"calendar", system:"Google Calendar", objectType:"event", objectName:"Dentist appointment", project:"Personal", externalId:"gcal-dentist-2", metadata:{ changedField:"time", before:"Tuesday · 3:00 PM", after:"Thursday · 11:00 AM" }, occurredAt:at(0,9,22) },
  { agentName:"Hermes · Scout", verb:"updated", summary:"Updated the launch checklist with final release owners.", category:"file", system:"Notion", objectType:"page", objectName:"Monologue launch checklist", project:"Monologue", externalId:"notion-launch-4", url:"https://notion.so/example/monologue-launch-checklist", metadata:{ pageId:"notion-launch-4", sectionsUpdated:3 }, occurredAt:at(0,8,46) },
  ...
  { agentName:"Instinct · Iris", verb:"booked", summary:"Booked a ride to SFO for the Tokyo flight.", category:"reservation", system:"Uber", objectType:"ride", objectName:"Home → SFO", project:"Tokyo Trip", value:62.35, currency:"USD", externalId:"uber-reservation-204", url:"https://m.uber.com/trips/uber-reservation-204", metadata:{ pickupWindow:"6:45–7:00 AM", passengers:2, confirmationCode:"UBR204" }, occurredAt:at(0,7,55) },
  ...
  { agentName:"Hermes · Scout", verb:"charged", summary:"Created the September software subscription charge.", category:"finance", system:"Stripe", objectType:"payment", objectName:"September subscription", project:"Personal", value:24.00, currency:"USD", externalId:"pi_92001", url:"https://dashboard.stripe.com/payments/pi_92001", metadata:{ paymentIntent:"pi_92001", customer:"cus_demo_104", receiptUrl:"https://dashboard.stripe.com/receipts/pi_92001" }, occurredAt:at(4,11,18) },
